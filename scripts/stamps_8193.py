...
orbit = 'orbit-8193'
sparse_pattern = '/pdo/ramp/orbit-8193/*sparse.fits'
...
process_sparse_into_stamps(sparse_pattern=sparse_pattern, stamps_directory=stamps_directory, ntimes=10, nstars=5)
